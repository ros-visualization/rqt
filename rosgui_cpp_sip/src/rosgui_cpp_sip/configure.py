...
ros_include_packages = ['rosgui_cpp', 'roslib', 'rosconsole', 'rostime', 'cpp_common', 'tinyxml', 'pluginlib']
...
link_libs = ['rosgui_cpp', 'roslib', 'rosconsole', 'rostime', 'cpp_common', 'tinyxml', 'poco_lite', 'boost_fs_wrapper']
